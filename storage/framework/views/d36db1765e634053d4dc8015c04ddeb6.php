                                                    ...
                                                    <div  class="tab-pane  fade show  <?php  if($count==1): ?> active <?php  endif;  ?>" id="pagetab<?php echo e($page->id); ?>">
                                                        ...
                                                        <div <?php  if($page->type=='v'):  ?> class="videobox" style="text-align: center"  <?php  endif;  ?>>
                                                            ...
                                                            <div style="text-align: center">
                                                                <a href="#" onclick="startMeeting('<?php echo e(stripWhiteSpace($zoomData['meeting_id'])); ?>','<?php echo e(stripWhiteSpace($zoomData['password'])); ?>','<?php echo e(generateSignatureZoom(stripWhiteSpace(setting('zoom_key')), stripWhiteSpace(setting('zoom_secret')), stripWhiteSpace($zoomData['meeting_id']), 0)); ?>')" class="btn btn-primary btn-lg"><i class="fa fa-video"></i> <?php echo app('translator')->get('default.join-meeting'); ?></a>
             ...
             //   externalLinkPage: './externalLinkPage.html',
                success: function () {
                 //   console.log(meetingConfig);
                    ...
                    ZoomMtg.i18n.reload("<?php echo e($langList[$lang]); ?>");
                    <?php endif; ?>
                    ZoomMtg.join({
...
<?php /**PATH C:\xampp-8.1\htdocs\app\resources\views/student/course/lecture.blade.php ENDPATH**/ ?>