                            ...
                            <ul id="nav" class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item">
                                    <a class="page-scroll dd-menu collapsed" href="javascript:void(0)"
                                       ...
                                       aria-controls="navbarSupportedContent" aria-expanded="false"
                                       aria-label="Toggle navigation"><i class="lni lni-user"></i>&nbsp; <?php echo e(__lang('account')); ?></a>
                                    <ul class="sub-menu collapse" id="submenu-1-5">
                                        <?php if(auth()->guard()->guest()): ?>
                                        <li class="nav-item"><a href="<?php echo e(route('register')); ?>"><?php echo e(__lang('register')); ?></a></li>
                                        <li class="nav-item"><a href="<?php echo e(route('login')); ?>"><?php echo app('translator')->get('default.login'); ?></a></li>
                                        <?php else: ?>
                                        <li class="nav-item"><a href="<?php echo e(route('home')); ?>"><?php echo app('translator')->get('default.my-account'); ?></a></li>
                                        <li  class="nav-item"><a   onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();" href="<?php echo e(route('logout')); ?>" ><?php echo e(__lang('logout')); ?></a></li>
                                        <?php endif; ?>
                                    </ul>
                                </li>
                                    <?php if(getCart()->getTotalItems()>0): ?>
                                <li class="nav-item"><a href="<?php echo e(route('cart')); ?>"><i class="lni lni-cart"></i>&nbsp; <?php echo e(__lang('your-cart')); ?><?php if(getCart()->getTotalItems()>0): ?> (<?php echo e(getCart()->getTotalItems()); ?>) <?php endif; ?></a></li>
                                    <?php endif; ?>
...
<?php /**PATH C:\xampp-8.1\htdocs\app\public\templates/edugridstwo/views/layouts/layout.blade.php ENDPATH**/ ?>