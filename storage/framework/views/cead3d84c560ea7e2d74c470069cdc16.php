        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="btn-group dropright">
                    ...
                    <div class="dropdown-menu dropright  wide-btn">
                        <a  class="dropdown-item show-modal" data-type="t"   data-target="#addt" href="#"><span class="title"><i class="fa fa-file-word"></i> <?php echo e(__lang('text')); ?></span></a>
                        <a class="dropdown-item" onclick="openLargeModal('<?php echo e(__lang('video-library')); ?>','<?php echo e(adminUrl(['controller'=>'lecture','action'=>'library','id'=>$id])); ?>')"  href="#"><span class="title"><i class="fa fa-file-video"></i>  <?php echo e(__lang('video-from-library')); ?> </span></a>
                        <a class="dropdown-item show-modal" data-type="v"   data-target="#addvurl" href="#"><span class="title"><i class="fa fa-file-video"></i> <?php echo e(__lang('external-video-url')); ?></span></a>
                        <a class="dropdown-item show-modal" data-type="v"   data-target="#addv" href="#"><span class="title"><i class="fa fa-file-video"></i> <?php echo e(__lang('external-video-embed')); ?></span></a>
                        <a class="dropdown-item show-modal"  data-type="i"    data-target="#addi" href="#"><span class="title"><i class="fa fa-image"></i> <?php echo e(__lang('image')); ?></span></a>
                        <a class="dropdown-item show-modal"  data-type="c"    data-target="#addc" href="#"><span class="title"><i class="fa fa-file-code"></i> <?php echo e(__lang('html-code')); ?></span></a>
                        <a class="dropdown-item show-modal"  data-type="q"    data-target="#addq" href="#"><span class="title"><i class="fa fa-question-circle"></i> <?php echo e(__lang('quiz')); ?></span></a>
                        <a class="dropdown-item show-modal-nc"  data-type="z"    data-target="#addz" href="#"><span class="title"><i class="fa fa-video"></i> <?php echo e(__lang('zoom-meeting')); ?></span></a>

                            <div class="dropdown-divider"></div>
                        <a class="dropdown-item "  href="<?php echo e(adminUrl(['controller'=>'lecture','action'=>'importimages','id'=>$id])); ?>"><span class="title"><i class="fa fa-image"></i> <?php echo e(__lang('import-images')); ?></span></a>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-8.1\htdocs\app\resources\views/admin/lecture/content.blade.php ENDPATH**/ ?>