    ...
    <div id="collapse<?php echo e($menu->id); ?>" class="collapse" aria-labelledby="heading<?php echo e($menu->id); ?>">
        <div class="accordion-body">
            ...
            <form method="post" class="menuform" action="<?php echo e(route('admin.menus.update-footer',['footerMenu'=>$menu->id])); ?>">
                ...
                <a onclick="return confirm('<?php echo app('translator')->get('default.confirm-delete'); ?>')" class="btn btn-danger deletemenu" href="<?php echo e(route('admin.menus.delete-footer',['footerMenu'=>$menu->id])); ?>"><?php echo app('translator')->get('default.delete'); ?></a>
...
<?php /**PATH C:\xampp-8.1\htdocs\app\resources\views/admin/partials/footer_menu.blade.php ENDPATH**/ ?>