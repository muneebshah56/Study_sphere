...
<?php $__env->startSection('crumb'); ?>
    <li><a href="<?php echo route('sessions'); ?>"><?php echo e(__lang('upcoming-sessions')); ?></a></li>
    <li><?php echo e(__lang('session-details')); ?></li>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="profile-info">
                                                <h5><a href="javascript:void(0)"><?php echo e($instructor->name.' '.$instructor->last_name); ?></a></h5>
...
<?php echo $__env->make(TLAYOUT, \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp-8.1\htdocs\app\public\templates/edugrids/views/site/catalog/session.blade.php ENDPATH**/ ?>