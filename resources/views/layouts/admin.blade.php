                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                               ...
                               @can('access','edit_registration_field')<li ><a class="nav-link" href="@route('admin.setting.fields')">{{ __lang('custom-student-fields') }}</a></li>@endcan
                                  ...
                                  {{--  @can('access','manage_currencies')<li
                                     ><a class="nav-link" href="@route('admin.setting.currencies')">{{ __lang('currencies') }}</a></li>@endcan --}}
                ...
                @if(config('app.credits')==true)
                    @if(saas())
                        <div class="mt-4 mb-4 p-3 hide-sidebar-mini">
                            <a target="_blank" href="" class="btn btn-primary btn-lg btn-block btn-icon-split">
                               dashboard
                            </a>
                        </div>
                    @else
