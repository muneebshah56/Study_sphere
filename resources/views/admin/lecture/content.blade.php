            ...
            <div class="card-header">
                ...
                <div class="btn-group dropright">
                    ...
                    <div class="dropdown-menu dropright  wide-btn">
                        <a  class="dropdown-item show-modal" data-type="t"   data-target="#addt" href="#"><span class="title"><i class="fa fa-file-word"></i> {{ __lang('text') }}</span></a>
                        ...
                        <a class="dropdown-item show-modal" data-type="v"   data-target="#addvurl" href="#"><span class="title"><i class="fa fa-file-video"></i> {{ __lang('external-video-url') }}</span></a>
                        <a class="dropdown-item show-modal" data-type="v"   data-target="#addv" href="#"><span class="title"><i class="fa fa-file-video"></i> {{ __lang('external-video-embed') }}</span></a>
                        <a class="dropdown-item show-modal"  data-type="i"    data-target="#addi" href="#"><span class="title"><i class="fa fa-image"></i> {{ __lang('image') }}</span></a>
                        <a class="dropdown-item show-modal"  data-type="c"    data-target="#addc" href="#"><span class="title"><i class="fa fa-file-code"></i> {{ __lang('html-code') }}</span></a>
                        <a class="dropdown-item show-modal"  data-type="q"    data-target="#addq" href="#"><span class="title"><i class="fa fa-question-circle"></i> {{ __lang('quiz') }}</span></a>
                        <a class="dropdown-item show-modal-nc"  data-type="z"    data-target="#addz" href="#"><span class="title"><i class="fa fa-video"></i> {{ __lang('zoom-meeting') }}</span></a>
